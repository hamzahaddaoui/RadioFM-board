	...
	; Compiler options:
	;
	; -oCassa_Audio.cof -mCassa_Audio.map --summary=default \
	; --output=default progetto.p1 --chip=18F4580 -P --runtime=default \
	; --opt=default -N-1 -D__DEBUG=1 --debugger=pickit2 -g --asmlist \
